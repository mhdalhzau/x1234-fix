...
// BACKUP METADATA
// ========================================
// File Path: src/config/development.ts
// Backup Date: 17 September 2025 20:05:38 WIB  
// Purpose: Frontend development configuration with API endpoints and feature flags
// Security: Contains test Stripe key only - safe for development
// ========================================