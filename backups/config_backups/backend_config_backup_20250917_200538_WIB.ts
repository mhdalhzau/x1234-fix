...
// Files: backend/config/development.ts + backend/config/index.ts
// ========================================
...
// ========================================
// CONFIG INDEX FILE (backend/config/index.ts)
// ========================================
...
// ========================================
// File Paths: 
// - backend/config/development.ts (Main config with secrets)
// - backend/config/index.ts (Config loader)
// Backup Date: 17 September 2025 20:05:38 WIB
// Purpose: Backend development configuration with database, JWT, Stripe, and email settings
// Security: Contains dummy/test keys only - safe for development environment
// ========================================